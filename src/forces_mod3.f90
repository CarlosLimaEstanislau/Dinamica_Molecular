    module forces_mod
        ...
        contains
            subroutine forces(positions, box, radius, p_tiu, delta, epsilon, bjl, kappa, r_cut, list, point, force, potential)
                ...
                real(dp) :: expfac, du_dx, du_dy, du_dz, du_dr, u, Bi, Bj, A
                real(dp) :: sr2, sr6, sr12, force_scalar_wca, pot_wca, pot_dlvo, force_scalar_dlvo
                ...
                do i = 1, n-1
                    do k = point(i), point(i+1) - 1
                        ...
                        if (surf_dist > 0.0_dp .and. surf_dist <= r_cut) then
                            ...
                            A = p_tiu(i)/radius(i) * p_tiu(j)/radius(j) * Bi * Bj * bjl
                            expfac = exp(-kappa * r)
                            ...
                            potential = potential + u + pot_dlvo
                        end if
